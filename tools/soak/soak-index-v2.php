...
/**
 * SiroPHP 48h Production Soak — Entry Point v2
 *
 * Exercises: HTTP, DB (SQLite), Cache (file/Redis), Session, Trace, Queue
 * Routes match harness.php weighted route expectations
...
$app->router->get('/api/cache/stampede', function () {
    ...
    $val = \Siro\Core\Cache::remember('soak:stampede_key', 10, function () {
        usleep(50000); // 50ms "expensive" computation
...
// /api/queue/dispatch — dispatch via framework Queue facade
