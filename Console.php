...
final class Console
{
    ...
    private function commandRegistry(): array
    {
        return [
            ...
            'db:health'    => ['handler' => DbHealthCommand::class, 'desc' => 'SQLite database health check', 'usage' => 'php siro db:health (SQLite only)'],
            'db:check'     => ['handler' => DbCheckCommand::class, 'desc' => 'SQLite database integrity check', 'usage' => 'php siro db:check (SQLite only)'],
            'db:stats'     => ['handler' => DbStatsCommand::class, 'desc' => 'SQLite database statistics', 'usage' => 'php siro db:stats (SQLite only)'],
            'db:optimize'  => ['handler' => DbOptimizeCommand::class, 'desc' => 'Optimize SQLite database', 'usage' => 'php siro db:optimize (SQLite only)'],
            'db:backup'    => ['handler' => DbBackupCommand::class, 'desc' => 'Backup SQLite database', 'usage' => 'php siro db:backup [--compress] (SQLite only)'],
